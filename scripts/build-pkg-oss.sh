diff --git a/scripts/build-pkg-oss.sh b/scripts/build-pkg-oss.sh
index 1111111..2222222 100755
--- a/scripts/build-pkg-oss.sh
+++ b/scripts/build-pkg-oss.sh
@@ -33,8 +33,14 @@ if ! command -v make >/dev/null 2>&1; then
 fi
