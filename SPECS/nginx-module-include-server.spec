...
Source100: https://github.com/vados-dev/ngx_http_include_server_module.git
...
%build
cd %{bdir} && git clone https://github.com/vados-dev/ngx_http_include_server_module.git
cd %{bdir}
