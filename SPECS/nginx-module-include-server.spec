...
Source1: nginx-module-include-server.copyright
...
git clone https://github.com/vados-dev/ngx_http_include_server_module.git
...
%{__install} -m 644 -p %{SOURCE1} \
    $RPM_BUILD_ROOT%{_datadir}/doc/nginx-module-include-server/COPYRIGHT
