...
Summary: nginx nginx-acme
Name: nginx-module-acme
Version: 1.30.0+0.3.1
Release: 1%{?dist}.ngx
Vendor: NGINX Inc.
URL: 
Group: %{_group}
...
Source1: nginx-module-acme.copyright
...
%define MODULE_CONFIGURE_ARGS $(echo "--add-dynamic-module=nginx-acme-0.3.1/")
...
tar -xf %{SOURCE100}
ln -sfn nginx-acme-* nginx-acme || true
...
%{__install} -m 644 -p %{SOURCE1} \
    $RPM_BUILD_ROOT%{_datadir}/doc/nginx-module-acme/COPYRIGHT
...
The nginx-acme for nginx has been installed.
