...
Source1: nginx-module-markdown-filter.copyright
...
git clone https://github.com/vados-dev/ngx_markdown_filter_module.git
...
%{__install} -m 644 -p %{SOURCE1} \
    $RPM_BUILD_ROOT%{_datadir}/doc/nginx-module-markdown-filter/COPYRIGHT
...
The Dynamic module markdown filter for nginx for nginx have been installed.
