...
%description module-markdown-filter
Dynamic module markdown filter for nginx.
...
%{__mkdir} -p $RPM_BUILD_ROOT%{_sysconfdir}/nginx/modules-enabled
...
%files module-markdown-filter
%{_libdir}/nginx/modules/ngx_markdown_filter_module.so
