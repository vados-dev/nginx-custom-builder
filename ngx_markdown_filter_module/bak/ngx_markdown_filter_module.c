...
static void cmark_extensions_cleanup(void *data)
{
    ...
    cmark_node *extensions = data;
//    cmark_llist *extensions = data;
    cmark_node_free(cmark_get_default_mem_allocator(), extensions);
...
static ngx_int_t ngx_markdown_body_filter(ngx_http_request_t *r, ngx_chain_t *chain)
{
    ...
    cmark_node *extensions = ctx->extensions;
